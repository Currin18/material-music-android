...
abstract class PlaybackBroadcast: BroadcastReceiver() {
    companion object {
        const val ACTION_PLAY_OR_PAUSE: String = "PlaybackBroadcast.ACTION_PLAY_OR_PAUSE"
        const val ACTION_PREVIOUS: String = "PlaybackBroadcast.ACTION_PREVIOUS"
        const val ACTION_NEXT: String = "PlaybackBroadcast.ACTION_NEXT"
//        const val ACTION_COMPLETION: String = "PlaybackBroadcast.ACTION_COMPLETION"
    }
